...
namespace WebApplication3OT.Controllers
{
    ...
    {
        private readonly WebApplication3OTContext _context;

        public EmployeesController(WebApplication3OTContext context)
        {
            _context = context;
        }
        ...
        {
            var webApplication3OTContext = _context.Employees.Include(e => e.Department);
            return View(await webApplication3OTContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication3OTContext.Employee'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
